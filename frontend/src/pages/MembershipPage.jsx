...
const MembershipPage = () => {
  ...
  const requestMembership = async (membershipType) => {
    ...
    try {
      ...
      let errorMessage =
        "Failed to submit membership request. Please try again later.";
  ...
  const cancelMembership = async () => {
    ...
    try {
      ...
      let errorMessage =
        "Failed to cancel membership request. Please try again later.";
        ...
        {requestStatus.message && (
          <div
            className={`${styles.statusMessage} ${
              requestStatus.error ? styles.errorMessage : ""
            } ${requestStatus.success ? styles.successMessage : ""}`}
          >
            {requestStatus.message}
          </div>
        )}
        ...
        {hasPendingRequest && (
          <div className={styles.pendingRequestNotice}>
            <p>
              ...
              {user.pendingMembership.membership_type === "creative_workspace"
                ? "Creative Workspace"
                : "Key Access"}{" "}
              membership.
            </p>
        ...
        <div className={styles.plansContainer}>
          ...
          <div className={styles.planCard}>
            <div className={styles.planTitleArea}>
              ...
              {hasPendingRequest &&
                user?.pendingMembership?.membership_type ===
                  "creative_workspace" && (
          ...
          <div className={styles.planCard}>
            <div className={styles.planTitleArea}>
              ...
              {hasPendingRequest &&
                user?.pendingMembership?.membership_type === "key_access" && (
                  <div className={styles.pendingLabel}>Request Pending</div>
                )}
            </div>
            <p className={styles.description}>
